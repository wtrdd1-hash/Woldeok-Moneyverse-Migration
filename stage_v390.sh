...
TEST_DST=/srv/moneyverse-data/releases/test-v390
PROD_DST=/srv/moneyverse-data/releases/prod-v390
PREV_PROD=/srv/moneyverse-data/releases/prod-bc2f820-v388
...
echo "=== Staging v390 release complete! ==="
