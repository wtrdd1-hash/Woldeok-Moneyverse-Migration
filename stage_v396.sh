...
TEST_DST=/srv/moneyverse-data/releases/test-b7d4a78e-v396
PROD_DST=/srv/moneyverse-data/releases/prod-b7d4a78e-v396
PREV_PROD=/srv/moneyverse-data/releases/prod-1767bed1-v395
...
echo "=== Staging v396 release complete! ==="
