...
TEST_DST=/srv/moneyverse-data/releases/test-v397
PROD_DST=/srv/moneyverse-data/releases/prod-v397
PREV_PROD=/srv/moneyverse-data/releases/prod-b7d4a78e-v396
...
echo "=== Staging v397 release complete! ==="
