...
export function TermsDocument() {
  return (
      ...
      <li>Discord, 웹 또는 관리자 기능의 접근 통제·권한 체계를 우회하는 행위</li>
      ...
      <ol>
      <li>운영자 권한은 최소 권한 원칙, 역할 검증 및 감사 기록에 따라 사용됩니다.</li>
      ...
      <li>이용자의 권리에 큰 영향을 주는 변경 또는 필수 개인정보 처리 내용의 변경은 다음 로그인 후 서비스 이용 전에 새 문서를 다시 확인하도록 합니다.</li>
      </ol>
      </section>
