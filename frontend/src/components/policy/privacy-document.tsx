...
export function PrivacyDocument() {
  return (
      ...
      <strong>핵심 원칙</strong>
      <p>OAuth 접근·갱신 토큰과 Google 이메일은 장기 저장하지 않습니다. 접속 IP는 보안·장애 대응을 위해 제한된 운영 데이터베이스에 저장하고 일반 화면과 Discord 운영 알림에는 축약 네트워크만 표시합니다. 홈·운영 소식·운영 검토 갤러리처럼 광고가 허용된 공개 정보 화면에서는 Google AdSense 광고가 표시될 수 있으며, 그 경우 Google의 광고 쿠키·식별자 사용과 선택 절차가 적용됩니다.</p>
      </aside>
      ...
      <p>서비스는 OAuth 접근 토큰·갱신 토큰·Google 이메일을 장기 저장하지 않습니다. 일반 이용자는 프로필 사진을 올리고, 갤러리 사진을 운영 검토용으로 제출할 수 있습니다. 공개 범위가 적용된 프로필 사진만 해당 범위의 이용자에게 제공하고, 갤러리 사진은 운영자가 검토·게시하기 전에는 공개하지 않습니다. 마케팅 수신 기능은 제공하지 않습니다. Google AdSense 광고는 홈·운영 소식·운영 검토 갤러리 등 공개 정보 화면에만 표시될 수 있으며, 경제 활동·잔액·거래·취향 정보를 광고 타기팅에 사용하지 않습니다.</p>
      ...
      <tr><th scope="row">Google LLC</th><td>미국. Google 로그인 선택 또는 광고가 허용된 공개 정보 화면 방문 시 TLS 암호화 통신으로 전송</td><td>로그인 제공자 식별자·표시명 또는 광고 쿠키·온라인 식별자·IP 주소. 인증 및 광고 제공·측정·부정 클릭 방지</td><td>Google 정책에 따른 기간. 로그인은 Discord를 선택할 수 있고, 광고 개인화는 Google 광고 설정 및 CMP에서 선택·거부할 수 있습니다.</td></tr>
      ...
      <p>로그인 이외에 광고가 허용된 공개 정보 화면에서는 Google AdSense가 광고 제공·빈도 관리·사기 방지·광고 개인화에 필요한 쿠키 또는 유사 식별자를 사용할 수 있습니다. Google 및 광고 기술 제공자는 각자의 정책에 따라 정보를 처리할 수 있습니다. 광고 개인화와 쿠키 설정은 Google 광고 설정에서 관리할 수 있습니다.</p>
      ...
      <p>광고는 실질적인 공개 정보가 있는 홈, 운영 소식 목록·상세, 운영자가 검토해 공개한 갤러리, 커뮤니티 광장 게시판 목록 화면에 표시할 수 있습니다. 개별 게시글·댓글 상세 화면에는 표시하지 않습니다. 로그인·계정·지갑·송금·상점 구매 화면·주식·대출·카지노·보상·관리자·상태·이용약관·개인정보처리방침 화면에는 표시하지 않습니다. 광고를 클릭하거나 새로고침하도록 유도하지 않으며, 광고 차단 여부와 관계없이 공개 콘텐츠를 제공합니다.</p>
      ...
      <strong>변경 이력</strong>
      <p>2026년 9월 9일: 커뮤니티 광장 게시판 목록 하단에 단일 광고 슬롯을 추가하고, 개별 사용자 게시글·댓글 상세 화면은 광고 없이 유지하도록 실제 광고 범위를 문서와 맞췄습니다. 광고 제공자·처리 목적·데이터 항목을 새로 추가하지 않는 배치 범위 조정이므로 기존 동의 버전을 유지합니다.</p>
      ...
      <p>2026년 9월 8일: 실제 광고 허용 범위가 홈 외 공개 운영 소식·운영 검토 갤러리에도 적용되는 점을 문서와 일치시키고, 상점 구매 화면에서는 광고를 제거했습니다. 새로운 개인정보 처리 목적을 추가하지 않는 운영 범위 정정이므로 2026-09-02 동의 버전을 유지합니다.</p>
