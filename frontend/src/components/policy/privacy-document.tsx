...
export function PrivacyDocument() {
  return (
      ...
      <p>광고는 실질적인 공개 정보가 있는 홈, 운영 소식 목록·상세, 운영자가 검토해 공개한 갤러리 화면에만 표시합니다. 로그인·계정·지갑·송금·상점 구매 화면·주식·대출·카지노·보상·관리자·상태·이용약관·개인정보처리방침 화면에는 표시하지 않습니다. 광고를 클릭하거나 새로고침하도록 유도하지 않으며, 광고 차단 여부와 관계없이 공개 콘텐츠를 제공합니다.</p>
