...
export default async function ForgotPasswordPage({ searchParams }: { searchParams: Promise<{sent?: string; error?: string}> }) {
  ...
  return <div data-page="forgot-password" className="mv-page mv-page--utility grid gap-6"><PageHeader title="비밀번호 재설정">가입한 이메일로 30분 동안 한 번 사용할 수 있는 재설정 링크를 보내드려요.</PageHeader>
