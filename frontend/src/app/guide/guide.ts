...
export const GUIDE_STEPS: readonly GuideStep[] = [
  ...
  },
  {
    ...
    points: [
      ...
      '작업별 서버 일일 배정 한도 안에서 반복하고 완료한 작업의 WLD·EXP 보상 획득',
    ],
    pointsEn: [
      ...
      'Repeat within each task’s server-enforced daily assignment limit and earn WLD and EXP for completed work',
    ],
...
export const CURRENT_IMPLEMENTED_FEATURES: readonly ImplementedFeatureGroup[] = [
  ...
  },
  {
    ...
    itemsEn: [
      ...
      'Server-settled marketplace listings, purchases, and cancellations',
    ],
