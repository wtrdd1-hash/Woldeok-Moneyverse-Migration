...
CREATE TABLE public.shop_catalog (
 ...
 effect_kind public.shop_effect_kind NOT NULL, effect jsonb NOT NULL DEFAULT '{}'::jsonb, purchase_limit text NOT NULL, active boolean NOT NULL DEFAULT true, created_at timestamptz NOT NULL DEFAULT clock_timestamp(), updated_at timestamptz NOT NULL DEFAULT clock_timestamp()
);
