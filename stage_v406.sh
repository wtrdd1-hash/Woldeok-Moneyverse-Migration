...
TEST_DST=/srv/moneyverse-data/releases/test-v406
PROD_DST=/srv/moneyverse-data/releases/prod-v406
PREV_PROD=/srv/moneyverse-data/releases/prod-v397
...
sudo cp -a "$SRC/packages/contract/dist" "$TEST_DST/packages/contract/" || true
...
echo "=== Staging v406 release complete! ==="
