...
## 기획 사이클 — v2026.09.20.311 (2026-09-20)
...
- **QA/승격:** 권한 우회, 비정상/overflow 금액, 중복 멱등성, 동시 보정, rollback, 예산 계산, 대사, 감사로그, 320/360/390px 모바일, BigInt 안전 검증을 Production 차단 조건으로 둔다. 실제 구현은 v2026.09.20.311-01~-07 순서와 exact-SHA Test → 병합 → 정확한 병합 SHA 재빌드 → 무중단 Production 승격 절차를 따른다.
