...
- [국제 언어·국가정책·수익화 명세](planning/INTERNATIONAL_LOCALE_JURISDICTION_MONETIZATION_SPEC.ko.md)
- [국제 규정 준수 근거 매트릭스](planning/INTERNATIONAL_COMPLIANCE_REFERENCE_MATRIX.ko.md)
- [가상 카지노 게임 시스템 명세](planning/CASINO_GAME_SYSTEM_SPEC.ko.md)
...
- [은행·신용·금융학습 안전 명세](planning/BANKING_CREDIT_SAFETY_SPEC.ko.md)

프로젝트 계획은 계속 갱신되는 초안/상시 명세입니다. 개발 시작 전과 개발 중간에 최신 내용을 다시 확인합니다.

## 아키텍처
- [시스템 개요](architecture/system-overview.ko.md)
- [요청 흐름](architecture/request-flow.ko.md)
- [데이터베이스 보안 경계](architecture/database-security.ko.md)
- [배포 흐름](architecture/deployment-flow.ko.md)

## 게임플레이 및 제품 기능
- [직업 및 성장](features/jobs-and-progression.ko.md)
- [퀘스트](features/quests.ko.md)
- [가상 카지노](features/casino.ko.md)
- [은행·신용·가상 채권](features/banking.ko.md)
- [가상 주식](features/stocks.ko.md)
- [가상 사업](features/businesses.ko.md)
- [상점 및 인벤토리](features/shop.ko.md)
- [관리자 제어 센터](features/admin-control-center.ko.md)

## 현지화 및 시각 자료
- [현지화 유지관리 정책](localization/README.ko.md)
...
## 운영
- [실제 배포 인프라 구조](INFRASTRUCTURE.ko.md)
- [릴리스 가이드](RELEASING.ko.md)
- [로컬 개발](operations/local-development.ko.md)
- [데이터베이스 마이그레이션](operations/database-migrations.ko.md)
- [백업 및 복구](operations/backup-and-recovery.ko.md)
...
- [`as` 캐스트 기록](as-casts.ko.md)
- [업데이트 로그](UPDATE_LOG.ko.md)

## 감사 / 확인 기록
- [프로젝트 부족 사항 감사 — 2026-09-07](findings/project-gap-audit-2026-09-07.ko.md)
- [공개 검색 노출 감사 — 2026-09-08](findings/public-discoverability-audit-2026-09-08.ko.md)
- [주식 조회 권한 문제 기록](findings/stock-reads-lack-grants.md) — 원문 자체가 한국어
- [사이트 부족 사항 점검서 — 2026-09-07](SITE_GAP_AUDIT_2026-09-07.md) — 원문 자체가 한국어
- [백업과 복구 상세 기록](BACKUP.md) — 원문 자체가 한국어
- [라우트 대조표](route-map.md) — 원문 자체가 한국어

## 릴리스 기록
- [v2026.09.07 게임플레이/UX/경제 안정성](releases/v2026.09.07.ko.md)
- [v2026.09.07.1 문서 및 쇼케이스](releases/v2026.09.07.1.ko.md)
- [v2026.09.07.2 현지화 가이드 동등성](releases/v2026.09.07.2.ko.md)
...
- [경제 소각처 v2026.09.12.5 변경 기록](changelog/2026-09-12-economy-sinks-v2026.09.12.5.ko.md)
...
- [Community & Market Integrity v2026.09.12.21 — 한국어](changelog/2026-09-12-community-market-integrity-v2026.09.12.21.ko.md)
- [Clubs & Cooperative Economy v2026.09.12.20 — 한국어](changelog/2026-09-12-clubs-cooperative-economy-v2026.09.12.20.ko.md)
- [Player Marketplace & Crafting v2026.09.12.16 — 한국어](changelog/2026-09-12-player-marketplace-crafting-v2026.09.12.16.ko.md)
- [Personal Spaces & City Projects v2026.09.12.11 — 한국어](changelog/2026-09-12-personal-spaces-city-projects-v2026.09.12.11.ko.md)
- [수익화·규정 준수·SEO v2026.09.12.27 — 한국어](changelog/2026-09-12-monetization-compliance-seo-v2026.09.12.27.ko.md)
- [2026-09-07 게임플레이/UX 작업 로그](worklog/2026-09-07-gameplay-ux-release.ko.md)
- [2026-09-07 앱 게이트웨이/갤러리/게시판 이미지 작업 로그](worklog/2026-09-07-app-gateway-gallery-board-images.ko.md)
- [2026-09-08 운영/관측성 작업 로그](worklog/2026-09-08-ops-observability-gap.ko.md)
- [2026-09-08 SEO/광고/법적 고지 작업 로그](worklog/2026-09-08-seo-ads-legal-audit.ko.md)
- [2026-09-08 공개 게시판/SEO 작업 기록](worklog/2026-09-08-public-board-seo.md) — 원문 자체가 한국어
- [2026-09-08 Test 환경 제거 기록](worklog/2026-09-08-remove-test-environment.md) — 원문 자체가 한국어
- [2026-09-09 GitOps 릴리스 계약 작업 기록](worklog/2026-09-09-gitops-release-contract.md) — 영어/한국어 병기
- [GitOps 릴리스 계약 구현 계획](superpowers/plans/2026-09-09-gitops-release-contract.ko.md)
