...
| # | 브랜치 | 마이그레이션 | 내용 |
|---|---|---|---|
| A1 | `feat/multi-origin-auth` | 없음 | **도메인 비종속 인증** — 설정 계층뿐이라 마이그레이션이 필요 없었다. 062는 A2로 넘어간다 |
| A2 | `feat/audit-trail` | 062–065 | 불변 해시체인 · 조회 감사 · 검색 · 무결성 검증 · 보존/파기 |
