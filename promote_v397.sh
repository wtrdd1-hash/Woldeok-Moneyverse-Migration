...
echo "=== [1/4] Promoting Test Environment to v397 ==="
sudo ln -sfn /srv/moneyverse-data/releases/test-v397 /srv/moneyverse-data/releases/test-current
...
echo "=== [3/4] Blue-Green Zero-Downtime Promoting Production to v397 ==="
sudo ln -sfn /srv/moneyverse-data/releases/prod-v397 /srv/moneyverse-data/releases/production-current
...
echo "=== Blue-Green Promotion to v397 Completed Successfully! ==="
